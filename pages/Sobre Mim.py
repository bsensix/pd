...
st.sidebar.markdown("- [Github](https://github.com/bnunis)")
...
col1.markdown(
    "Na aba à **esquerda**, você encontrará alguns desses projetos e abaixo um pouco da minha experiência com tecnologias, artigos e cursos."
)
